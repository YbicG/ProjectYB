...
import { setupCloudflareApiIpc } from './ipc/cloudflare-api.ipc';
import { setupLocalProxyIpc } from './ipc/local-proxy.ipc';
import { setupCloudSyncIpc } from './ipc/cloud-sync.ipc';
import { setupHostsIpc } from './ipc/hosts.ipc';
import { setupLogStreamIpc } from './ipc/logstream.ipc';
import { setupOpenApiIpc } from './ipc/openapi.ipc';
import { setupGitConflictIpc } from './ipc/git-conflict.ipc';
...
async function createWindow() {
  ...
  setupCloudflareApiIpc();
  setupLocalProxyIpc();
  setupCloudSyncIpc();
  setupHostsIpc();
  setupLogStreamIpc(mainWindow);
  setupOpenApiIpc();
  setupGitConflictIpc();
