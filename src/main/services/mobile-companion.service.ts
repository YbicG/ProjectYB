...
export class MobileCompanionService extends EventEmitter {
  ...
  private async handleAuthenticatedApi(
    ...
    // ── 3. Running Services & Process Management ──
    ...
    // ── 4. Mobile Command Runner / Terminal ──
    ...
    // ── 5. Git Status & 1-Click Operations ──
