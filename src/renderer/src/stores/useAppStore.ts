...
export type TabType = 'dashboard' | 'overview' | 'api' | 'terminals' | 'git' | 'services' | 'tunnels' | 'database' | 'pipelines' | 'mock-server' | 'ai-hub' | 'dependencies' | 'optimizer' | 'settings' | 'project-detail'
