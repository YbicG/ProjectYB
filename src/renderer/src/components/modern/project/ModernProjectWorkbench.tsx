                          ...
                          {isRunning ? (
                            ...
                            <>
                              <Button
                                ...
                                className="h-7 text-xs border-amber-500/30 bg-amber-950/20 text-amber-300 hover:bg-amber-950/40 gap-1 px-2"
                      ...
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <div className="flex items-center gap-1 shrink-0">
                          ...
                          <Button
                            ...
                            className="h-7 px-1.5 text-xs font-mono border-amber-500/30 bg-amber-950/20 hover:bg-amber-900/30 text-amber-300 hover:text-amber-200 gap-1"
                            title="Spawn Administrator Terminal in Subproject"
                          >
